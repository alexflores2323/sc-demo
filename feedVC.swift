...
//  insta
//
//  Created by Logan Caracci on 3/15/17.
...
class feedVC: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(feedVC.uploaded(_:)), name: Notification.Name(rawValue: "uploaded"), object: nil)
